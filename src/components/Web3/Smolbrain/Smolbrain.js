...
function Smolbrain() {
  ...
  return (
    <div class="text-center">
      ...
      <h3 class="text-secondary text-lg">At the moment you must enter your smol id in Hex format...</h3>

      <div class='container flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full pt-10'>
      
        <input class="w-96 border border-input-border bg-input px-4 py-4" type="text"  placeholder="Smol ID in Hex" onChange= {(e) =>{
