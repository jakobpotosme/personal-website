...
const Coin = ({image,name,symbol,price,volume, priceChange, marketcap}) => {
  return (
    <div className='coin-container' class="container flex text-xl ">
        <div className='coin-row' class="flex flex-row justify-items-start items-center h-80 mx-auto ">
            ...
            <div className='coin' class="flex items-center pl-12 pr-24 text-xl  ">
                ...
                <p className='coin-symbol'  class="mx-auto ml-12">{symbol.toUpperCase()}</p>
            </div>
            <div className="coin-data" class="flex items-center  mx-auto ">
                <p className='coin-price' class="mx-auto "> ${price}</p>
                <p className='coin-volume' class="mx-auto xl:mr-12 ml-24"> ${volume.toLocaleString()}</p>
                {priceChange < 0 ? (
                                <p className="coin-percent red" class="xl:ml-12  text-red-400">
                                    {priceChange.toFixed(2)}%
                                </p>
                            ) : (
                                <p className="coin-percent green" class="xl:ml-12 text-green-400">
                                    {priceChange.toFixed(2)}%
                                </p>
                            )}
                <p className="coin-marketcap" class="mx-auto  ml-24 mr-12 ">
